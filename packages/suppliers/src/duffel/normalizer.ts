...
// Handles both one-way and round-trip (multi-slice) offers.
// Only normalizes the first outbound slice for fare comparison;
// the full raw offer is preserved for booking.
...
/* ── Duffel response types (only the fields we use) ───────────── */
